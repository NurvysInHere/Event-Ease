...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($token) || empty($new_password) || empty($confirm_password)) {
        ...
        $check_sql = "SELECT id, email, reset_token, reset_token_expiry FROM users WHERE reset_token = :token AND reset_token_expiry > NOW()";
        ...
        if ($check_stmt->rowCount() > 0) {
            ...
            $update_sql = "UPDATE users SET password = :password, reset_token = NULL, reset_token_expiry = NULL WHERE id = :id";
...
<head>
    ...
    <title>Reset Password | Event Ease</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap">
    <style>
        /* Gunakan CSS yang sama dengan forgot_password.php */
        :root {
...
<body>
    ...
    <div class="main-content">
        <div class="reset-container">
            <div class="logo-reset">Event Ease</div>
            <h2>Reset Password</h2>
            <h3>Masukkan token dan password baru Anda</h3>
            ...
            <div class="instructions">
                ...
                <ul>
                    <li>Masukkan token yang dikirim ke email Anda</li>
                    <li>Buat password baru yang kuat</li>
                    <li>Konfirmasi password baru Anda</li>
                    <li>Password minimal 6 karakter</li>
                    <li>Token hanya berlaku selama 1 jam</li>
                </ul>
            </div>

            <form method="POST" id="resetForm">
                <div class="form-group">
                    <label for="token"><i class="fas fa-key"></i> Token Reset Password</label>
                    <input type="text" id="token" name="token" placeholder="Masukkan token dari email" required
                        value="<?= isset($_POST['token']) ? htmlspecialchars($_POST['token']) : (isset($_GET['token']) ? htmlspecialchars($_GET['token']) : '') ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="confirm_password" name="confirm_password" placeholder="Konfirmasi password baru" required minlength="6">
                </div>
            ...
            <a href="forgot_password.php" class="btn-back">
                <i class="fas fa-arrow-left"></i> Minta Token Baru
            </a>
